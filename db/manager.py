...
_COLUMN_RENAMES = (
    ...
    ("documents", "doc_number", "document_number"),
    ("documents", "doc_type", "document_type"),
    ("documents", "doc_class", "document_class"),
    ("documents", "doc_index", "document_index"),
    ("welds", "welder_id", "welder_stencil_number"),
    ("welds", "material", "base_material"),
    ("welds", "pwht_done", "pwht_completed"),
    ("welds", "hold", "is_on_hold"),
    ("welds", "ndt_percent_rt", "ndt_extent_rt_pct"),
    ("welds", "ndt_percent_pt", "ndt_extent_pt_pct"),
    ("welds", "left_qty", "left_quantity"),
    ("welds", "right_qty", "right_quantity"),
    ("line_list", "ndt_percent_rt", "ndt_extent_rt_pct"),
    ("line_list", "ndt_percent_ut", "ndt_extent_ut_pct"),
    ("line_list", "ndt_percent_pt", "ndt_extent_pt_pct"),
    ("line_list", "ndt_percent_mt", "ndt_extent_mt_pct"),
    ("line_list", "dn", "size_dn"),
    ("test_packages", "dia_inch_total", "dia_inch"),
    ("test_packages", "inch_meter", "inch_metre"),
    ("test_packages", "linecheck_finished", "line_check_finished"),
    ("test_packages", "linecheck_result", "line_check_result"),
    ("test_packages", "linecheck_result_date", "line_check_result_date"),
    ("test_packages", "linecheck_subcontractor", "line_check_subcontractor"),
    ("material_takeoff", "two_year_qty", "two_year_quantity"),
    ("material_takeoff", "purchase_qty", "purchase_quantity"),
    ("material_takeoff", "miv_qty", "miv_quantity"),
    ("project_actions", "action_by_1", "performed_by_1"),
    ("project_actions", "action_by_2", "performed_by_2"),
    ("weld_report_drafts", "rt_no", "rt_report_number"),
    ("weld_report_drafts", "pt_no", "pt_report_number"),
    ("weld_report_drafts", "ut_no", "ut_report_number"),
    ("weld_report_drafts", "welder_id", "welder_stencil_number"),
    ("weld_reports", "rt_no", "rt_report_number"),
    ("weld_reports", "pt_no", "pt_report_number"),
    ("weld_reports", "ut_no", "ut_report_number"),
    ("weld_reports", "welder_id", "welder_stencil_number"),
    ("welders", "qualified_material_p_no", "qualified_p_number"),
    ("blowing_records", "pressure_bar", "pressure_barg"),
    ("purging_records", "pressure_bar", "pressure_barg"),
    ("boxup_records", "manway_flange_no", "manway_flange_number"),
    ("material_issue_records", "issued_qty", "issued_quantity"),
    ("technical_queries", "related_document", "related_document_number"),
    ("companies", "logo_path", "logo_file_path"),
    ("ndt_records", "inspector_id", "inspector_stamp"),
    ("work_fronts", "target_qty", "target_quantity"),
    ("work_fronts", "actual_qty", "actual_quantity"),
    ("pipe_supports", "base_metal", "base_material"),
    ("pipe_supports", "type_2", "support_subtype"),
    ("pipe_supports", "location_desc", "location_description"),
    ("punch_items", "location_desc", "location_description"),
    ("blind_list_records", "location_desc", "location_description"),
)
...
_SCHEMA_PATCHES = (
    ...
    ("line_list", "ndt_extent_pt_pct", "FLOAT DEFAULT 0"),
    ("line_list", "ndt_extent_mt_pct", "FLOAT DEFAULT 0"),
    ("line_list", "insulation_thickness_mm", "FLOAT"),
    ("line_list", "sour_service", "BOOLEAN DEFAULT 0"),
    ("line_list", "size_dn", "VARCHAR(30)"),
    ...
    ("welds", "ndt_extent_rt_pct", "FLOAT"),
    ("welds", "ndt_extent_pt_pct", "FLOAT"),
    ...
    ("welds", "left_quantity", "FLOAT"),
    ("welds", "right_component", "VARCHAR(150)"),
    ("welds", "right_quantity", "FLOAT"),
    ("welds", "is_on_hold", "BOOLEAN DEFAULT 0"),
    ...
    ("pipe_supports", "base_material", "VARCHAR(100)"),
    ...
    ("pipe_supports", "support_subtype", "VARCHAR(80)"),
    ...
    ("test_packages", "dia_inch", "FLOAT"),
    ("test_packages", "inch_metre", "FLOAT"),
    ("test_packages", "line_check_finished", "BOOLEAN DEFAULT 0"),
    ("test_packages", "line_check_result", "VARCHAR(40)"),
    ("test_packages", "line_check_result_date", "DATE"),
    ("test_packages", "line_check_subcontractor", "VARCHAR(150)"),
    ...
    ("project_actions", "performed_by_1", "VARCHAR(100)"),
    ("project_actions", "performed_by_2", "VARCHAR(100)"),
    ...
    ("documents", "document_class", "VARCHAR(50)"),
    ("documents", "document_index", "VARCHAR(50)"),
    ...
    ("material_takeoff", "two_year_quantity", "FLOAT"),
    ("material_takeoff", "purchase_quantity", "FLOAT"),
    ...
    ("material_takeoff", "miv_quantity", "FLOAT"),
)
