...
ALIASES = {
    ...
    "pwhtreq": "pwht_required", "rtpercent": "ndt_extent_rt_pct", "ptpercent": "ndt_extent_pt_pct",
    "sf": "weld_type", "testpackageno": ("test_package_number", "package_number"),
    "jointstatus": "status", "basemetal": "base_material",
    "left": "left_component", "leftqty": "left_quantity",
    "right": "right_component", "rightqty": "right_quantity",
    "jointremark": "remarks", "isexpired": "is_expired", "hold": "is_on_hold",
    "documenttype": "document_type",
    "documentno": ("document_number", "source_document_number"),
    "documentdate": "document_date", "rtno": "rt_report_number",
    "actionsby1": "performed_by_1", "actionsby2": "performed_by_2",
    "workfront": "work_front", "link": "link_url",
    "addby": "created_by", "editby": "updated_by",
    "filelocation": "file_path",
    "class": "document_class", "index": "document_index", "sheet": "sheet_number",
    "welderid": "welder_stencil_number", "welder": "welder_name",
    ...
    "relateddocumentdrawing": "related_document_number",
    ...
    "diainch": "dia_inch",
    "inchmeter": "inch_metre", "inchmetre": "inch_metre",
    "tmedum": "test_medium", "tmedium": "test_medium",
    "testbar": "test_pressure_barg",
    "finlinecheck": "line_check_finished",
    "linecheckresultdate": "line_check_result_date",
    "linecheckresult": "line_check_result",
    "linechecksubcon": "line_check_subcontractor",
    ...
    "compnayname": "name", "companyname": "name", "logo": "logo_file_path",
    "targetqty": "target_quantity", "actualqty": "actual_quantity",
}
...
NATURAL_KEYS = {
    ...
    Document: ["document_number"], WorkFront: ["front_code"], WorkTeam: ["team_code"],
